...
#define HAVE_vec_extract_lo_v4df_mask ((TARGET_AVX512F) && (TARGET_AVX \
   && TARGET_AVX512VL && TARGET_AVX512DQ \
   && !(MEM_P (operands[0]) && MEM_P (operands[1]))))
#define HAVE_vec_extract_hi_v4di_maskm (TARGET_AVX512DQ && TARGET_AVX512VL \
   && rtx_equal_p (operands[2], operands[0]))
#define HAVE_vec_extract_hi_v4df_maskm (TARGET_AVX512DQ && TARGET_AVX512VL \
   && rtx_equal_p (operands[2], operands[0]))
#define HAVE_vec_extract_hi_v4di_mask (TARGET_AVX512VL && TARGET_AVX512DQ)
#define HAVE_vec_extract_hi_v4df_mask (TARGET_AVX512VL && TARGET_AVX512DQ)
...
extern rtx        gen_vec_extract_hi_v4di_maskm                  (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_extract_hi_v4df_maskm                  (rtx, rtx, rtx, rtx);
