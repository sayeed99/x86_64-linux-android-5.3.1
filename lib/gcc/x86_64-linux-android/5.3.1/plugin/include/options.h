...
enum opt_code
{
  ...
  OPT_nostartfiles = 1287,                   /* -nostartfiles */
  OPT_nostdinc = 1288,                       /* -nostdinc */
  OPT_nostdinc__ = 1289,                     /* -nostdinc++ */
  OPT_nostdlib = 1290,                       /* -nostdlib */
  OPT_o = 1291,                              /* -o */
  OPT_p = 1292,                              /* -p */
  OPT_pass_exit_codes = 1293,                /* -pass-exit-codes */
  /* OPT_pedantic = 1294, */                 /* -pedantic */
  OPT_pedantic_errors = 1295,                /* -pedantic-errors */
  OPT_pg = 1296,                             /* -pg */
  OPT_pie = 1297,                            /* -pie */
  OPT_pipe = 1298,                           /* -pipe */
  OPT_posix = 1299,                          /* -posix */
  OPT_print_file_name_ = 1300,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1301,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1302,          /* -print-multi-directory */
  OPT_print_multi_lib = 1303,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1304,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1305,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1306,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1307,               /* -print-prog-name= */
  OPT_print_search_dirs = 1308,              /* -print-search-dirs */
  OPT_print_sysroot = 1309,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1310,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1311,                        /* -profile */
  OPT_pthread = 1312,                        /* -pthread */
  OPT_quiet = 1313,                          /* -quiet */
  OPT_r = 1314,                              /* -r */
  OPT_rdynamic = 1315,                       /* -rdynamic */
  OPT_remap = 1316,                          /* -remap */
  OPT_s = 1317,                              /* -s */
  OPT_s_bc_abi = 1318,                       /* -s-bc-abi */
  OPT_save_temps = 1319,                     /* -save-temps */
  OPT_save_temps_ = 1320,                    /* -save-temps= */
  OPT_shared = 1321,                         /* -shared */
  OPT_shared_libgcc = 1322,                  /* -shared-libgcc */
  /* OPT_specs = 1323, */                    /* -specs */
  OPT_specs_ = 1324,                         /* -specs= */
  OPT_static = 1325,                         /* -static */
  OPT_static_libasan = 1326,                 /* -static-libasan */
  OPT_static_libgcc = 1327,                  /* -static-libgcc */
  OPT_static_libgcj = 1328,                  /* -static-libgcj */
  OPT_static_libgfortran = 1329,             /* -static-libgfortran */
  OPT_static_libgo = 1330,                   /* -static-libgo */
  OPT_static_liblsan = 1331,                 /* -static-liblsan */
  OPT_static_libmpx = 1332,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1333,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1334,               /* -static-libstdc++ */
  OPT_static_libtsan = 1335,                 /* -static-libtsan */
  OPT_static_libubsan = 1336,                /* -static-libubsan */
  /* OPT_std_c__03 = 1337, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1338, */                /* -std=c++0x */
  OPT_std_c__11 = 1339,                      /* -std=c++11 */
  OPT_std_c__14 = 1340,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1341, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1342, */                /* -std=c++1y */
  OPT_std_c__1z = 1343,                      /* -std=c++1z */
  OPT_std_c__98 = 1344,                      /* -std=c++98 */
  OPT_std_c11 = 1345,                        /* -std=c11 */
  /* OPT_std_c1x = 1346, */                  /* -std=c1x */
  /* OPT_std_c89 = 1347, */                  /* -std=c89 */
  OPT_std_c90 = 1348,                        /* -std=c90 */
  OPT_std_c99 = 1349,                        /* -std=c99 */
  /* OPT_std_c9x = 1350, */                  /* -std=c9x */
  OPT_std_f2003 = 1351,                      /* -std=f2003 */
  OPT_std_f2008 = 1352,                      /* -std=f2008 */
  OPT_std_f2008ts = 1353,                    /* -std=f2008ts */
  OPT_std_f95 = 1354,                        /* -std=f95 */
  OPT_std_gnu = 1355,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1356, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1357, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1358,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1359,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1360, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1361, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1362,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1363,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1364,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1365, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1366, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1367,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1368,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1369, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1370, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1371,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1372, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1373, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1374, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1375,                     /* -std=legacy */
  OPT_symbolic = 1376,                       /* -symbolic */
  OPT_t = 1377,                              /* -t */
  OPT_time = 1378,                           /* -time */
  OPT_time_ = 1379,                          /* -time= */
  OPT_tno_android_cc = 1380,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1381,                 /* -tno-android-ld */
  OPT_traditional = 1382,                    /* -traditional */
  OPT_traditional_cpp = 1383,                /* -traditional-cpp */
  OPT_trigraphs = 1384,                      /* -trigraphs */
  OPT_u = 1385,                              /* -u */
  OPT_undef = 1386,                          /* -undef */
  OPT_v = 1387,                              /* -v */
  OPT_version = 1388,                        /* -version */
  OPT_w = 1389,                              /* -w */
  OPT_wrapper = 1390,                        /* -wrapper */
  OPT_x = 1391,                              /* -x */
  OPT_z = 1392,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
